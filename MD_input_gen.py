...
A thin shim. The implementation lives in `md_templates.openmm.cli_input_gen` so that it ships in the
...
`md-input-gen` uses the installed package.
"""
...
from md_templates.openmm.cli_input_gen import InputError, main  # noqa: E402
