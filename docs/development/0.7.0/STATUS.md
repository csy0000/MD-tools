...
- CUDA: `alchemy/windows.py`'s CUDA sites are covered by S4's G1 lane (PASS on CUDA). A2's CUDA lane has 5 of 10 failing (S3, diagnosing); the S1 ladders stay BLOCKED with no card granted.
