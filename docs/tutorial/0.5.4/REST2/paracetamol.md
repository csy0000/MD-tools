# REST2 (0.5.4): paracetamol in explicit water, 10 ns per state
...
!!! info "What changed since 0.5.3"
    ...
    was left unscaled, before a single step runs. Compare [the 0.5.3 page](../../REST2/paracetamol.md).
...
* the same ladder for a rigid molecule: [REST2 (0.5.4): Chinolin](chinolin.md)
