...
def check_template_provenance(here, project, *, manifest=None, stage=None, inputs=None,
    ...
    `dataset.yaml` says which MD-tools the dataset was generated by; the provenance files, the
    ...
    if disagreeing:
        ...
        return [_no("template provenance",
                    ...
                    f"dataset and the scripts in it were not generated by the same MD-tools")]
