...
from .schemas import canonical_json, sha256_text
...
RUNTIME_ONLY_PATHS: dict[str, str] = {
    ...
    "production.remd.total_ns_per_replica": "how long to run the same ladder",
    ...
    "production.md.total_ns": "unused by REST2",
